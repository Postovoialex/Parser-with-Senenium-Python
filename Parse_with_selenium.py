...
# и нет прямого обращения к серверу. Если вы хотите сделать более быстрый парсер то используйте Beautiful Soup и Requests.
...
workbook = xlsxwriter.Workbook(r'C:\Users\PC\Desktop\Work\Рейтинг\Детальный рейтинг %s.xlsx' % now) # Создаю файл excel с именем детальный рейтинг + текущая дата для того что бы имя файлов при ежедневном использовании не повторялись 
...
# Можно использовать любое другое местоположение где будет лежать браузер, мне было удобно так. 
