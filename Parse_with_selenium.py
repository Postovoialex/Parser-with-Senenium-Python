...
#Работает данный код не слишком быстро, так как особенностью является загрузка страницы, а только после - фиксация данных, так как все завязано на браузере, а точнее, на том, как быстро он загрузит страницу
#Если вы хотите сделать более быстрый парсер используйте модули Beautiful Soup и Requests.
